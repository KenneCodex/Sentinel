...
| **Seal** | Evidence that a governance condition was satisfied at a point in time. | Validator result set for a specific artifact/version. | Deterministic validator execution + pass/fail outputs. | Signed or stored validation transcript; CI logs. |

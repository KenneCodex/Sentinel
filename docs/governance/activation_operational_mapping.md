...
| **Doctrine** | Canonical standards language that implementation must consume. | Sentinel governance docs, standards, and contracts. | Review and validator confirmation against doctrine artifacts. | Merged governance artifact with traceable commit history. |

...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    random_parser.add_argument("--out", type=str, default="audit/bin_harness/runs.jsonl")
    random_parser.add_argument("--summary", type=str, default="audit/bin_harness/summaries/latest.json")
    ...
    exhaustive_parser.add_argument("--out", type=str, default="audit/bin_harness/runs.jsonl")
    exhaustive_parser.add_argument("--summary", type=str, default="audit/bin_harness/summaries/latest.json")
    ...
    file_parser.add_argument("--out", type=str, default="audit/bin_harness/runs.jsonl")
    file_parser.add_argument("--summary", type=str, default="audit/bin_harness/summaries/latest.json")
